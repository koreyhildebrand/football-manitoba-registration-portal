...
# ====================== VERSION CONTROL ======================
VERSION = "v3.55"  # FULL COMPLETE SCRIPT - All pages working. Equipment: Pant Pads = heading only, summary only shows checked items, size boxes greyed out, summary matches sheet exactly after save
