...
if page == "📋 Players":
    ...
    st.info("Full permission management editor coming soon.\n\nYou can currently manage users directly in the **Users** sheet.")
...
st.caption("✅ St. Vital Mustangs Registration Portal | Login Working + Full Navigation")
