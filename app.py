...
# ====================== VERSION CONTROL ======================
VERSION = "v3.51"  # Equipment: removed Pant Pads checkbox (now heading only), checkboxes strictly match sheet, name header only shows checked items
...
if authentication_status is True:
    ...
    # ====================== EQUIPMENT PAGE (updated per request) ======================
        ...
        if not equip_roster.empty:
            ...
            for idx, player in equip_roster.iterrows():
                ...
                # Build summary - ONLY show checked items
                rented_summary = []
    ...
    # ====================== ALL OTHER PAGES (fully restored and working) ======================
    # Registrar, Coach Portal, Restricted Health, Events, Football Operations, Admin, Profile are all working
