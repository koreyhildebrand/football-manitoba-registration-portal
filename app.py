...
nav_options = []
nav_options.append("📋 Players")
nav_options.append("📋 Registrar")
...
if page == "📋 Players":
    ...
    st.write("You can change your password below.")
    
    # Fixed password update call
    try:
...
st.caption("✅ St. Vital Mustangs Registration Portal | Export tab removed | Profile fixed")
